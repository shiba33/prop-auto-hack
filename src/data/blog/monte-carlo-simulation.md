...
標準的なMCは各トレードが独立（i.i.d.）と仮定しますが、実際のトレードには**自己相関**（勝ちが続いたり負けが続いたりする傾向）があります。

ブロックブートストラップ（連続する10トレードを1ブロックとしてリサンプリング）で検証すると、**i.i.d.仮定のMCは合格率を3〜20pt過大評価**していることがわかりました。
...
MCの結果を鵜呑みにせず、**保守的に見積もる**癖をつけることが大切です。
